...
public class NotificationTest {
	...
	@Test
	public void message_for_extra_hot_chocolate() {
		Order order = new Order(OrderType.CHOCOLATE, 1,true);
		String actualMessage = notification.sendMessage(order,OrderType.CHOCOLATE.price,TypeMessage.SUCCES);
	...
	@Test
	public void message_for_extra_hot_cofee() {
		Order order = new Order(OrderType.COFFEE, 1,true);
		String actualMessage = notification.sendMessage(order,OrderType.COFFEE.price,TypeMessage.SUCCES);
		String expectedMessage = "Drink maker makes 1 extra hot coffee with 1 sugar and a stick";
		assertEquals(expectedMessage, actualMessage);
	}
	...
	@Test
	public void message_for_extra_hot_tea() {
		Order order = new Order(OrderType.TEA, 1,true);
		String actualMessage = notification.sendMessage(order,OrderType.TEA.price,TypeMessage.SUCCES);
		String expectedMessage = "Drink maker makes 1 extra hot tea with 1 sugar and a stick";
		assertEquals(expectedMessage, actualMessage);
	}
