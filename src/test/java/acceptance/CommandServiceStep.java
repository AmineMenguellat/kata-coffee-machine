...
public class CommandServiceStep {
	...
	@When("I choose the option extra hot a {string}")
	public void i_choose_the_option_extra_hot_a(String extraHot) {
		commandService.deliverExtraHot("true".equals(extraHot)); 
	}
